...
## 🧠 IntelliLearn-SmartStudyAssitant

> AI-powered Smart Study Assistant using Retrieval-Augmented Generation (RAG).
...
`Python` `FastAPI` `FAISS` `Sentence Transformers` `React`

---

## ⏱️ MinuteMaster_AI

> AI Meeting Assistant that converts meetings into structured knowledge.
